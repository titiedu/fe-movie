        ...
        <div className='container px-4 mx-auto'>
            <div className='movie-info my-8 border p-4 rounded-lg shadow-md'>
                <div className='show-info flex flex-col  sm:flex-row w-full'>
                    <div className='poster w-5/12 sm:basis-1/4 '>
                    ...
                    <div className='info w-12/12 sm:basis-3/4 sm:pl-4 mt-4 sm:mt-0'>
                        ...
                        <div className='border-t pt-4'>
                            <Tabs defaultValue="dstap" className="w-full">
                                ...
                                <TabsContent value="dstap" className='episode-list flex flex-wrap gap-4 mt-2 w-full'>
                                ...
                                <TabsContent value="moviekhac">phim khác.</TabsContent>
                            </Tabs>
                        </div>
                    </div>
                </div>
