...
const NamPhatHanhPage = () => {
    ...
    const { data, error, isLoading } = useSWR(`${process.env.NEXT_PUBLIC_API_MOVIE_URL}/v1/api/nam-phat-hanh/${slug}/?page=${trang}`, fetcher,
        {
...
export default NamPhatHanhPage